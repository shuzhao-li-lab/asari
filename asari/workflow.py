...
def process_project(list_input_files, parameters):
    ...
    Parameters
    ----------
    list_input_files : list of centroided mzML files from LC-MS metabolomics. Usually found in a folder.
...
def make_iter_parameters(sample_registry, parameters, shared_dict):
    ...
    Parameters
    ----------
    sample_registry : dictionary like {'sample_id': ii, 'input_file': file}, 
...
def single_sample_EICs_(sample_id, infile, ion_mode, database_mode,
    ...
    Parameters
    ----------
    sample_id : sample id passed from sample_registry by make_iter_parameters.
    infile : input mzML file, passed from sample_registry by make_iter_parameters.
    ion_mode, database_mode, mz_tolerance_ppm, min_intensity, min_timepoints, min_peak_height, outfile :
...
def process_xics(list_input_files, parameters):
    ...
    Parameters
    ----------
    list_input_files : list of centroided mzML files from LC-MS metabolomics. 
...
def get_mz_list(infile):
    ...
    Parameters
    ----------
    infile : input table, which is tab or comma delimited and has m/z in the first column,
        header as first row.
